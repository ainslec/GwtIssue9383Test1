function issue9383test1(){
  ...
  issue9383test1.__sendStats = sendStats;
  issue9383test1.__moduleName = $intern_4;
  issue9383test1.__errFn = null;
  issue9383test1.__moduleBase = $intern_6;
  issue9383test1.__softPermutationId = $intern_7;
  issue9383test1.__computePropValue = null;
  issue9383test1.__getPropMap = null;
  issue9383test1.__installRunAsyncCode = function(){
  }
  ;
  issue9383test1.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  issue9383test1.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  issue9383test1.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  issue9383test1.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[issue9383test1.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (issue9383test1.__errFn) {
        script.onerror = function(){
          issue9383test1.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  issue9383test1.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  issue9383test1.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    issue9383test1.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return issue9383test1.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    issue9383test1.__getPropMap = function(){
      var result = {};
    ...
    ;
    issue9383test1.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = issue9383test1.__getPropMap;
    ...
    issue9383test1.__softPermutationId = softPermutationId;
  ...
  processMetas();
  issue9383test1.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = issue9383test1.__moduleBase;
...
issue9383test1.succeeded = issue9383test1();
